...
exports.adminforgotPassword = async (req, res) => {
  ...
  try {
    ...
    console.log("DBJXC HBHFDC",dataValues);
      ...
      let mailOptions = {
        ...
        html: `<style>@import url('https://fonts.googleapis.com/css2?family=Cabin&display=swap');</style>
                        ...
                        <div style="text-align: center; font-family: 'Cabin', sans-serif; margin: auto;">
                            <img style="display: block; margin-left: auto; margin-right: auto;" src="https://api.sarisanitary.com/images/sarie.jpg" alt="" height="150">
